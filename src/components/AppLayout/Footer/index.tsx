...
const Footer = (): React.ReactElement => {
  ...
  return (
    <footer className={classes.footer}>
      <span className={classes.item}>©{date.getFullYear()} Shyft</span>
      <span className={classes.sep}>|</span>
      <Link className={cn(classes.item, classes.link)} target="_blank" to="https://shyft.network">
        Shyft Network
      </Link>
      <span className={classes.sep}>|</span>
      <Link className={cn(classes.item, classes.link)} target="_blank" to="https://shyftfederation.com">
        Shyft Federation
      </Link>
      <span className={classes.sep}>-</span>
